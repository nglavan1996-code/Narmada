...
\      | "admin"    | "admin123"|
  ...
  /**
   * Playwright TypeScript Page Object Prompt (No Test Code)
   */
  PLAYWRIGHT_TYPESCRIPT_PAGE_ONLY: `
    Instructions:
    - Generate ONLY a Playwright TypeScript Page Object (no test runner code).
    - Export a class that accepts a Playwright \`page\` in the constructor and exposes meaningful methods.
    - Use Playwright best practices (page.locator, await navigation, no sleeps).
    - Include JSDoc for class and methods. Do NOT include explanatory text.
    ...
    Tone:
    - Concise, idiomatic TypeScript for Playwright.
  `
};
