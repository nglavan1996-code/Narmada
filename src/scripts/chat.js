...
class ChatUI {
    ...
    getPromptKeys(language, engine) {
        ...
        const isTypeScriptPlaywright = (lang === 'typescript' || lang === 'ts') && eng === 'playwright';
        ...
        if (!isFeatureChecked && !isPageChecked) {
            ...
            } else if (isTypeScriptPlaywright) {
        ...
        if (isFeatureChecked && isPageChecked) {
            ...
            if (this.isJavaSelenium(lang, eng)) {
                ...
                // For Playwright + TypeScript: generate feature file + Playwright page
                promptKeys.push('CUCUMBER_ONLY');
                promptKeys.push('PLAYWRIGHT_TYPESCRIPT_PAGE_ONLY');
            } else {
                // For other combinations, generate separately and warn
                promptKeys.push('CUCUMBER_ONLY');
